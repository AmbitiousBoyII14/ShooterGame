...
public class HUD {
    ...
    public HUD() { font = new BitmapFont(); font.setColor(Color.WHITE); font.getData().setScale(2.0f); }
    public void render(SpriteBatch batch, Player player) {
        ...
        String jetpackStr = "JETPACK: "; int bars = (int)((player.jetpackFuel / player.maxJetpackFuel) * 10);
        for (int i = 0; i < 10; i++) { if (i < bars) jetpackStr += "|"; else jetpackStr += "."; }
