...
public class GameMap {
    ...
    public GameMap() {
        ...
        platforms.add(new Platform(0, 0, worldWidth, 50)); // Ground
        platforms.add(new Platform(0, 50, 50, worldHeight - 50)); // Left Wall
        platforms.add(new Platform(worldWidth - 50, 50, 50, worldHeight - 50)); // Right Wall
